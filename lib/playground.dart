  ...
  MDCMenu _initSamplesMenu({bool nullSafe = false}) {
    ...
    if (nullSafe) {
      samples = [
        ...
        Sample(
            'fdd369962f4ff6700a83c8a540fd6c4c', 'Bloc example', Layout.flutter),
        ...
        Sample('4a68e553746602d851ab3da6aeafc3dd', 'HTTP example', Layout.dart),

        // d57c6c898dabb8c6fb41018588b8cf73 Firebase
      ];
    } else {
      samples = [
        Sample('c0f7c578204d61e08ec0fbc4d63456cd', 'Hello World', Layout.dart),
