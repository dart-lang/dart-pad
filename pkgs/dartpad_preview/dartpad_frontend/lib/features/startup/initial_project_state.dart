...
final class InitialProjectState {
  ...
  ///
  /// Gists without a root pubspec receive one using the selected SDK's version.
  ...
  factory InitialProjectState.resolve(ProjectRequest request, Project contents, List<SdkInfo> sdks) {
    final inferredDependencies = request.source is GistProjectSource && !contents.containsFile('pubspec.yaml')
    ...
    if (inferredDependencies != null) {
      ...
      Logger('InitialProjectState').info(
        'Autogenerated missing pubspec.yaml for Gist "${(request.source as GistProjectSource).id}".',
      );
    }
