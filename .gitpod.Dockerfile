...
RUN sudo apt-get update && \
    wget https://storage.googleapis.com/dart-archive/channels/stable/release/2.13.0/linux_packages/dart_2.13.0-1_amd64.deb && \
    sudo dpkg -i dart_2.13.0-1_amd64.deb && \
